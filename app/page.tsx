...
import { CallCalling, Send2 } from "iconsax-reactjs";
...
export default function Home() {
  return (
    <div className="min-h-screen relative pt-[5rem] bg-white overflow-x-hidden wrap-break-word">
      {/* Header */}
      <Header />
      ...
      <section className="pt-[80px] py-12 lg:py-0 md:pt-0 lg:pt-0 px-4">
        <div className="grid container mx-auto lg:px-10 md:grid-cols-2 gap-0 md:gap-8 items-start">
          <div className="space-y-3 md:space-y-6 container  pb-[6rem] mt-auto">
            ...
            <p className="text-black text-base lg:text-lg">
              Finde die passenden Saiten und das richtige Zubehör für deinen
              Tennisschläger - passend zu deinem individuellen Spielstil.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 py-6">
              <div className="flex items-center gap-2">
                <div className="bg-[#1A7F401A] size-8 shrink-0 rounded-full flex justify-center items-center">
                  <Image src={"/spin.svg"} width={22} height={22} alt="" />
                </div>
              ...
              <div className="flex items-center gap-2">
                <div className="bg-[#1A7F401A] size-8 shrink-0 rounded-full flex justify-center items-center">
                  <Image src={"/control.svg"} width={25} height={25} alt="" />
                </div>
                <span className="text-sm font-bold text-[#1E1E1E]">
                  Mehr Kontrolle
                </span>
              ...
              <div className="flex items-center gap-2">
                <div className="bg-[#1A7F401A] size-8 shrink-0 rounded-full flex justify-center items-center">
                  <Image src={"/power.svg"} width={20} height={20} alt="" />
                </div>
                <span className="text-sm font-bold text-[#1E1E1E]">
                  Mehr Power
                </span>
            ...
            <Link target="_blank" href="https://wa.me/+41774245391" className="cta-2">
              Schreib mir
            </Link>
          </div>
          <Image
            ...
            width={300}
            height={400}
            className="mx-auto relative lg:h-screen w-auto max-md:rounded-[1.75rem] z-10 object-cover  lg:translate-x-14 lg:-translate-y-20 lg:max-w-[100vw]"
          />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-lg:px-4 lg:px-10">
          <div className="grid md:grid-cols-2 max-lg:w-full gap-6 lg:gap-12 items-center">
            ...
            <div className="space-y-3">
              ...
              <Link target="_blank" href="https://wa.me/+41774245391" className="cta">
                Ruf mich an <CallCalling color="#ffff" variant="TwoTone" />
              </Link>
                    ...
                    <div className="flex justify-between items-center gap-3">
                      <div className="w-full md:max-w-[248px]">
                        ...
                        <p className="text-[12px] sm:text-sm text-black">
                          Mit hochwertigen Saiten, schneller Bearbeitung und individuell angepasster Spannung für optimale Leistung.
                        </p>
                      </div>
                      <Image
                  ...
                  <CardContent className="p-0">
                    <div className="flex justify-between items-center gap-3">
                      ...
                      <div className="w-full md:max-w-[248px]">
                        ...
                        <p className="text-[12px] sm:text-sm text-black">
                          Lass deine Overgrips für mehr Komfort und Kontrolle austauschen und statte dich mit Zubehör wie Dämpfern und Griffen aus.
                        </p>
                      </div>
                    </div>
                  </CardContent>
                ...
                <div className="flex items-start gap-3 w-full  bg-[#1A7F400D] rounded-[15px] p-4 min-h-[122px] border border-[#1A7F400D]">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-black">
                      Professionelle und persönliche Beratung mit individueller Saitenempfehlung abgestimmt auf deinen Spielstil.
                    </p>
                  </div>
                </div>
      ...
      <section className="px-4 lg:px-10 container mx-auto">
        <div className="container rounded-[25px] mx-auto bg-[#F4F9F5] shadow-none flex flex-col md:flex-row gap-6  md:gap-12 items-center justify-between h-full lg:max-h-[428px] px-5 py-8 md:px-[40px] relative overflow-hidden">
          ...
          <div className="bg-white rounded-3xl p-5 lg:px-[68px] lg:py-[40] space-y-6 w-full max-w-[481px] flex flex-col justify-between z-20">
            <h3 className="text-xl text-center md:text-start lg:text-2xl font-bold text-black mb-4">
            ...
            <Link
              style={{ width: "100%" }}
              target="_blank"
              href="https://wa.me/+41774245391"
              className="cta"
            >
              Schreib ein Whatsapp <CallCalling color="#ffff" variant="TwoTone" />
            </Link>

            <div className="flex items-center justify-center w-full gap-2 text-sm text-gray-600">
              <Link
                target="_blank"
                href="mailto:robinho.engelburg@gmail.com"
                className="grid grid-cols-[auto_1fr_auto] items-center gap-2 lg:gap-3 w-full"
              >
                <Send2 className="h-[3rem] w-[3rem]" color="#000000" />
                <div className="w-fit">
